...
3. Apply `migrations/0001_initial.sql` to a new database. For an existing deployment, apply each later migration in order through `migrations/0013_other_income.sql`.
